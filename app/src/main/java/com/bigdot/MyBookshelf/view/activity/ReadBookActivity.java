...
import com.bigdot.basemvplib.AppActivityManager;
import com.bigdot.basemvplib.BitIntentDataManager;
...
import com.bigdot.MyBookshelf.help.ChapterContentHelp;
import com.bigdot.MyBookshelf.help.ReadBookControl;
import com.bigdot.MyBookshelf.help.permission.Permissions;
import com.bigdot.MyBookshelf.help.permission.PermissionsCompat;
import com.bigdot.MyBookshelf.model.ReplaceRuleManager;
import com.bigdot.MyBookshelf.model.TxtChapterRuleManager;
import com.bigdot.MyBookshelf.presenter.ReadBookPresenter;
import com.bigdot.MyBookshelf.presenter.contract.ReadBookContract;
import com.bigdot.MyBookshelf.service.ReadAloudService;
import com.bigdot.MyBookshelf.utils.BatteryUtil;
import com.bigdot.MyBookshelf.utils.NetworkUtils;
import com.bigdot.MyBookshelf.utils.ScreenUtils;
import com.bigdot.MyBookshelf.utils.SoftInputUtil;
import com.bigdot.MyBookshelf.utils.StringUtils;
import com.bigdot.MyBookshelf.utils.SystemUtil;
import com.bigdot.MyBookshelf.utils.bar.BarHide;
import com.bigdot.MyBookshelf.utils.bar.ImmersionBar;
import com.bigdot.MyBookshelf.utils.theme.ATH;
import com.bigdot.MyBookshelf.utils.theme.ThemeStore;
import com.bigdot.MyBookshelf.view.popupwindow.CheckAddShelfPop;
import com.bigdot.MyBookshelf.view.popupwindow.MediaPlayerPop;
import com.bigdot.MyBookshelf.view.popupwindow.MoreSettingPop;
import com.bigdot.MyBookshelf.view.popupwindow.ReadAdjustMarginPop;
import com.bigdot.MyBookshelf.view.popupwindow.ReadAdjustPop;
import com.bigdot.MyBookshelf.view.popupwindow.ReadBottomMenu;
import com.bigdot.MyBookshelf.view.popupwindow.ReadInterfacePop;
import com.bigdot.MyBookshelf.view.popupwindow.ReadLongPressPop;
import com.bigdot.MyBookshelf.widget.modialog.BookmarkDialog;
import com.bigdot.MyBookshelf.widget.modialog.ChangeSourceDialog;
import com.bigdot.MyBookshelf.widget.modialog.DownLoadDialog;
import com.bigdot.MyBookshelf.widget.modialog.InputDialog;
import com.bigdot.MyBookshelf.widget.modialog.MoDialogHUD;
import com.bigdot.MyBookshelf.widget.modialog.ReplaceRuleDialog;
import com.bigdot.MyBookshelf.widget.page.PageLoader;
import com.bigdot.MyBookshelf.widget.page.PageLoaderNet;
import com.bigdot.MyBookshelf.widget.page.PageView;
import com.bigdot.MyBookshelf.widget.page.TxtChapter;
import com.bigdot.MyBookshelf.widget.page.animation.PageAnimation;
